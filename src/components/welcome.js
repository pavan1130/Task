...
function Welcome() {
    ...
    const donutChartOptions = {
        ...
        legend: 'none',
        pieHole: 0.5,
        colors: ['red', 'rgb(255, 162, 0)', 'rgb(30, 144, 144)', 'rgb(164, 39, 164)', '#9900ff', '#ff00cc'], // Specify your desired colors
        chartArea: {
            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col">
                        ...
                        <div>
                            <p>Welcome to the <strong>Cutover Automation Dashboard!</strong> Wth our powerful automation tools, you can seamlessely orchestrate cutover activities, reduce downtime, and enhance project success.</p>
                        </div>
                                    ...
                                    <div className="col">
                                        <div className="row row-one align-items-center">
                                            <div className="parent-row-one">
                                                <div className="directvsindirect mx-2">Direct vs Indirect</div>
